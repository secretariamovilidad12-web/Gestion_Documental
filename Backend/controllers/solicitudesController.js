...
const { emitirEventoChat } = require('./chatController');
...
async function obtenerMotivos(req, res) {
    try {
        const resultado = await pool.query(
            `
...
async function crearSolicitud(req, res) {
    ...
    try {
        ...
        emitirEventoChat('mensaje-creado', mensaje);
...
async function aprobarSolicitud(req, res) {
    ...
    try {
       ...
       `,
        ...
        emitirEventoChat('solicitud-actualizada', mensajeSolicitud);
        emitirEventoChat('mensaje-creado', mensajeAprobacion.rows[0]);
...
async function rechazarSolicitud(req, res) {
    ...
    try {
        ...
        emitirEventoChat('solicitud-actualizada', mensajeSolicitud);
        emitirEventoChat('mensaje-creado', mensajeRechazo.rows[0]);
